...
#question for desision tree splitting
class Question:
...
#function counts the occurrences of each class label in the dataset.          
...
#function calculates and returns the probability distribution of class labels at a leaf node.
...
dt_model_final= joblib.load('C:/xampp/htdocs/agriculture-portal/farmer/ML/crop_prediction/filetest2.pkl') 
