...
<div class="card text-white bg-gradient-success mb-3">
				  ...
				  <span class=" text-success display-4" > Result  </span>					
					...
					$command = escapeshellcmd("C:\Users\Administrator\AppData\Local\Programs\Python\Python311\python.exe ML/crop_prediction/ZDecision_Tree_Model_Call.py $JsonState $JsonDistrict $JsonSeason");
					exec($command, $output);
